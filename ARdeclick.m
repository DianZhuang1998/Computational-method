function [x, i] = ARdeclick(x, p, N, H, detThresh, detStretch, numIter)
%
% This function removes clicks from the specified wavfile using an
...
for chan = 1:numChannels
    ...
    for k = 0:numWin
        ...
        [clean_frame, frame_i] =  ARdeclickFrame(frame, fhead, p, detThresh, detStretch, numIter);
...
function [x, i] =  ARdeclickFrame(x, xhead, p, detThresh, detStretch, numIter)
...
i = clickdetect(ehat, stdhat, detThresh, detStretch);
